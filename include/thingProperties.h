...
#include "arduino_secrets.h"
  ...
  #define BOARD_ID "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" //TODO!!! Enter your board ID here
#endif
 
// INSERT FUNCTIONS AND VARIABLES HERE -- GENERATED BY ARDUINO CLOUD
...
void initProperties() {
  ...
  // INSERT PROPERTYS HERE -- GENERATED BY ARDUINO CLOUD
